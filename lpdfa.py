...
transition, i.e. the 4-tuple generated by the most inner generator returned by
`crg.parse`. The function then construct these transitions into the LPDFA for
the (CA state, guard) configuration.
